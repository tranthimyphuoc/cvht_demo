...
const SEED = {
  ...
  criteriaNN: [
    ...
    },
    {
      ...
      max: 2,
      desc: 'Định kỳ 01 tuần/lần, Lớp trưởng tổng hợp tình hình lớp và thực hiện báo cáo gửi GV/TG. Nội dung báo cáo gồm: tình hình chuyên cần, kết quả học tập, danh sách sinh viên có nguy cơ, các vấn đề phát sinh và đề xuất hướng xử lý hoặc hỗ trợ.',
      example: '',
    },
    {
      id: 5,
