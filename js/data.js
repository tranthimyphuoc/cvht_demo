...
const SEED = {
  ...
  /**
   * Lớp trưởng Ngoại ngữ — báo cáo tuần 5 tiêu chí × 2 điểm = /10
   */
  criteriaNN: [
    {
      id: 1,
      title: 'Nhận và thông báo lại cho lớp',
      max: 2,
      desc: 'Khi nhận được thông báo từ Giảng viên/Trợ giảng (GV/TG) về lịch học, lịch thi, lịch nghỉ, thay đổi phòng học, bài tập, dự án hoặc các hoạt động của lớp, Lớp trưởng có trách nhiệm chuyển tiếp đầy đủ, chính xác và kịp thời đến toàn bộ sinh viên qua Lark Group. Đối với các thông báo quan trọng, cần @all để đảm bảo tất cả thành viên đều nhận được thông tin, đồng thời nhắc nhở trước các mốc thời gian quan trọng.',
      example: '@all Thông báo từ GV: Tuần sau nghỉ học thứ Năm, học bù vào thứ Bảy (15/04). Các bạn lưu ý sắp xếp thời gian tham gia đầy đủ.',
    },
    {
      id: 2,
      title: 'Thúc đẩy tương tác lớp học',
      max: 2,
      desc: 'Khuyến khích sinh viên tích cực tham gia phát biểu, thảo luận, làm việc nhóm, thuyết trình, role-play và các hoạt động học tập trên lớp. Chủ động động viên, ghi nhận các cá nhân hoặc nhóm tích cực; đồng thời nhắc nhở nhẹ nhàng các sinh viên còn thụ động để nâng cao tinh thần học tập của lớp.',
      example: 'Nhóm 1 được GV đánh giá rất tốt. Các nhóm còn lại chuẩn bị nội dung để tuần sau trình bày nhé!',
    },
    {
      id: 3,
      title: 'Theo dõi chuyên cần và phát hiện sinh viên có nguy cơ',
      max: 2,
      desc: 'Theo dõi sĩ số từng buổi học, ghi nhận thông tin từ GV/TG về tình trạng đi học, đi trễ hoặc vắng mặt của sinh viên. Đặc biệt lưu ý các trường hợp nghỉ từ 02 buổi liên tiếp, mất liên lạc, thường xuyên không nộp bài tập hoặc không tham gia hoạt động nhóm để kịp thời báo cáo và phối hợp hỗ trợ.',
      example: 'Sinh viên B nghỉ liên tiếp 02 buổi, chưa nộp 03 bài tập và không phản hồi tin nhắn trên Lark. Lớp trưởng ghi nhận và báo cáo GV/TG để theo dõi.',
    },
    {
      id: 4,
      title: 'Báo cáo định kỳ (01 tuần/lần)',
      max: 2,
      desc: 'Định kỳ 01 tuần/lần, Lớp trưởng tổng hợp tình hình lớp và thực hiện báo cáo trên Lark Base gửi GV/TG. Nội dung báo cáo gồm: tình hình chuyên cần, kết quả học tập, danh sách sinh viên có nguy cơ, các vấn đề phát sinh và đề xuất hướng xử lý hoặc hỗ trợ.',
      example: 'Báo cáo tuần (01/04–07/04): 22/25 sinh viên tham gia đầy đủ; 03 sinh viên vắng (01 có phép, 02 không phép); 20/25 sinh viên nộp bài đúng hạn; 01 sinh viên có nguy cơ do nghỉ học nhiều và mất liên lạc.',
    },
    {
      id: 5,
      title: 'Nhận phản hồi và triển khai',
      max: 2,
      desc: 'Sau khi nhận phản hồi hoặc chỉ đạo từ GV/TG, Lớp trưởng có trách nhiệm triển khai đầy đủ đến sinh viên, theo dõi việc thực hiện, nhắc nhở các trường hợp chưa hoàn thành và phản hồi lại kết quả khi được yêu cầu.',
      example: 'Sau khi GV yêu cầu bổ sung bài tập trước 17:00, Lớp trưởng thông báo trên Lark Group, nhắc các sinh viên chưa nộp và cập nhật tình hình hoàn thành cho GV/TG.',
    },
  ],
